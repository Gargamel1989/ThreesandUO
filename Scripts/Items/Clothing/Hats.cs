...
namespace Server.Items
{
	public abstract class BaseHat : BaseClothing, IShipwreckedItem
	{
		...
		public override int OnCraft( int quality, bool makersMark, Mobile from, CraftSystem craftSystem, Type typeRes, Type typeRes2, BaseTool tool, CraftItem craftItem, int resHue )
		{
